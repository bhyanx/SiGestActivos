...
function ListarCombosFiltros() {
  $.ajax({
    ...
    success: (res) => {
      if (res.status) {
        console.log("Datos de categorías recibidos:", res.data.categorias);
        ...
        console.log("Valor actual de filtroCategoria:", $("#filtroCategoria").val());
      } else {
        Swal.fire(
          "Filtro de movimientos",
          "No se pudieron cargar los combos: " + res.message,
...
function listarActivosTable() {
  $("#tblRegistros").DataTable({
    ...
    ajax: {
      ...
      type: "POST",
      data: function() {
        var categoriaValue = $("#filtroCategoria").val() || 1;
        console.log("Enviando categoría:", categoriaValue);
        return {
          IdArticulo: "",
          IdActivo: "",
          pIdCategoria: categoriaValue
        };
      },
      dataType: "json",
      dataSrc: function (json) {
