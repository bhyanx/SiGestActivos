...
<body>
    <div class="document">
        ...
        <div class="header">
            ...
            <div class="document-info">
                ...
                <div class="guide-title">GESTION DE ALMACEN<br>VALE DE SALIDA DE ACTIVOS</div>
    ...
    <div class="action-buttons">
        ...
        <button onclick="descargarPDF()" class="btn btn-pdf">
            <i class="fas fa-file-pdf text-white"></i> Descargar PDF (HTML)
        </button>
        <button onclick="descargarPDFNativo()" class="btn btn-pdf" style="background: #28a745;">
            <i class="fas fa-file-pdf text-white"></i> Descargar PDF (Nativo)
        </button>
    </div>
    ...
    <script>
        ...
        function descargarPDFNativo() {
            const idMovimiento = <?php echo json_encode($idMovimiento); ?>;
            window.open('reporteMovimientoPDF.php?id=' + idMovimiento, '_blank');
        }
    </script>
</body>
