...
//   })
//   $.ajax({
//     url: '../../controllers/Configuracion.php?op=combo_empresa',
//     type: 'POST',
//     async: false,
//     success: (res) => {
//       // console.log(res)
...
//   $.ajax({
//     url: '../../controllers/Configuracion.php?op=combo_unidades_negocio',
//     type: 'POST',
//     data:{
...
function Login(e) {
  ...
  $.post(
    "../../controllers/UsuarioController.php?op=login",
    {
...
$(document).on("click", "#btnmostrarocultarpass", (e) => {
  var tipoinput = $("#ClaveAcceso").prop("type");
  if (tipoinput === "password") {
    $("#ClaveAcceso").prop("type", "text");
    $("#iconinputpass").removeClass().addClass("fas fa-eye-slash");
  } else {
    $("#ClaveAcceso").prop("type", "password");
