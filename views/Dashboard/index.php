...
if (isset($_SESSION["CodRol"]) /*AND isset($_SESSION["vgcodEmpresa"]) AND isset($_SESSION["vgCodCaja"])*/) {
?>
  <!DOCTYPE html>
  <html>
  ...
  <head lang="es">
    ...
    ?>
    <title>Inicio - Sistema Atención Playa</title>
  </head>
        ...
        <section class="content">
          <div class="row">
            <div class="col-md-6 col-lg-3 col-xl-2">
              <div class="card shadow">
                <div class="card-body">
                  <img class='img-fluid w-100' src="../../public/img/logo-<? /*= $_SESSION['vgcodEmpresa']*/ ?>.png" alt="" />
                </div>
              </div>
            </div>
            <div class="col-md-6 col-lg-3 col-xl-2">
          ...
          <div class="row">
            <div class="col-md-12 col-lg-12 col-xl-4 order-last">
              <div class="card bg-gradient-<?= $_SESSION['TemaColor'] ?>">
                  <div class="card-header border-0">
                      ...
                      <div class="card-tools">
                          ...
                          <button type="button" class="btn btn-<?= $_SESSION['TemaColor'] ?> btn-sm" data-card-widget="collapse">
