...
<script src="../../public/js/lib/jquery/jquery-3.7.1.min.js"></script>
    ...
    <script>
        ...
        //     $.ajax({
        //         url: "../../controllers/usuario.php?op=update_tipocambio",
        //         type: "POST",
        //         // async: false,
        //         success: (res) => {
        //             res = JSON.parse(res);
        //             //console.log(res)
        //             $("#tcambiolabel").val(`T.C. Compra: ${res.compra}, Venta: ${res.venta} - SUNAT`)
        //         },
        //     });
        // }        
        ...
        if(basename(getcwd()) != 'Login'){
            if (!$tienepermiso) {
                echo '<script> 
                      let timerInterval;
                      Swal.fire({
                          title: "Sistema Gestión Lubriseng!",
                          html: "No tienes permiso ni acceso a este Módulo",
                          timer: 3000,
